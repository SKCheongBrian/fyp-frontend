...

{
  ...
  Statement
      ...
      { return { node: 'SynchronizedStatement', expression: expr.expression, body: body, location: location() } }
      ...
      { return { node: 'LabeledStatement', label: id, body: statement, location: location() }; }
      / Indent comment:EndOfLineComment
      { return { node: "EndOfLineComment", comment: comment.value }; }
      / Indent comment:TraditionalComment
      { return { node: "TraditionalComment", comment: comment.value }; }
  ...
  QualifiedIdentifierSuffix
      ...
      { return { node: 'TypeLiteral', type: buildTypeName(qual, null, []), location: location() }; }
  ...
  ExplicitGenericInvocationSuffix
      ...
      { return { node: 'MethodInvocation', arguments: args, name: id, typeArguments: [], location: location() }; }
  ...
  Selector
      ...
      { return { node: 'MethodInvocation', arguments: args, name: id, typeArguments: [], location: location() }; }
      / DOT id:Identifier
      { return { node: 'FieldAccess', name: id, location: location() }; }
      ...
      / expr:DimExpr
      { return { node: 'ArrayAccess', index: expr, location: location() }; }
